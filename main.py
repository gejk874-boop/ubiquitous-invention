...
# === КОНФИГУРАЦИЯ ===
BOT_TOKEN = "8243992851:AAGoLj2MowK2_ft_dKfnIo1TjfK6tArfMsQ"
...
ℹ️ **Помощь** - получите справку по работе бота
    ...
    try:
        with open('Lumii_20251122_105626106.jpg', 'rb') as photo:
        ...
        logger.warning("Фотография для команды /start не найдена")
