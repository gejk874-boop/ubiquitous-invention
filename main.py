...
# ===== ЗАПУСК ДЛЯ PYTHONANYWHERE =====
if __name__ == "__main__":
    print("🚀 Starting bot for PythonAnywhere...")
    
    # Инициализация БД
    init_db()
    
    # Создание клиента с оптимизацией для бесплатного хостинга
    app = Client(
        "my_bot",
        api_id=API_ID,
        api_hash=API_HASH,
        bot_token=BOT_TOKEN,
        workers=1,  # Минимум workers для экономии памяти
        sleep_threshold=60,  # Увеличенный порог сна
    )
